...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="bg-white/90 backdrop-blur rounded-xl border-2 border-green-300 shadow-lg overflow-hidden transition-all">
      ...
      >
        <span className="font-semibold text-green-900 text-lg pr-8">
          {question}
        </span>
        <svg
    ...
    >
      ...
      <nav className="container mx-auto p-4 sm:p-6 flex justify-between items-center">
        <div className="flex items-center space-x-2 sm:space-x-3">
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full flex items-center justify-center overflow-hidden relative">
            <Image
              src="/logo.png"
              alt="AUPreps Logo"
              fill
          ...
          <h1
            className="text-xl sm:text-2xl md:text-3xl font-bold text-green-800"
            style={{
              textShadow:
                "1px 1px 0 white, -1px -1px 0 white, 1px -1px 0 white, -1px 1px 0 white, 1px 1px 0 white, -1px -1px 0 white, 1px -1px 0 white, -1px 1px 0 white",
            }}
          >
            AUPreps
          </h1>
          ...
          {user ? (
            <>
              ...
              <Link href="/profile">
                <Button
                  variant="outline"
                  className="border-green-600 text-green-700 hover:bg-green-50 text-sm sm:text-base px-3 sm:px-4"
                >
                  Profile
                </Button>
              </Link>
            ...
            <>
              <Link href="/login">
                <Button
                  variant="ghost"
                  className="text-green-800 hover:bg-green-50 text-sm sm:text-base px-3 sm:px-4"
                >
                  Login
                </Button>
              </Link>
              <Link href="/register">
                <Button className="bg-linear-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white shadow-lg text-sm sm:text-base px-3 sm:px-4">
      ...
      <section className="container mx-auto px-6 py-24 text-center">
        <h1
          className="text-5xl md:text-7xl font-bold mb-8 text-green-900"
          style={{
            textShadow:
        ...
        >
          Score <span className="text-green-600">300+</span> in JAMB
          <br />
          Smash WAEC with <span className="text-yellow-600">A1s</span>
        </h1>
        <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto text-gray-700 font-medium">
          50,000+ Real Past Questions • AI Explanations • Timed Tests •
          Leaderboard
        </p>
        <div className="space-x-6">
          <Link href="/register">
            <Button
              size="lg"
              className="text-lg px-12 py-8 bg-linear-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white shadow-2xl"
            >
              Start Free Trial - Pro Access
            </Button>
          </Link>
        </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-4 text-green-900">
          Choose Your Plan
        </h2>
        <p className="text-center text-gray-600 mb-12 sm:mb-16 max-w-2xl mx-auto px-4">
          Start your journey with our free plan and upgrade when you are ready
          for unlimited AI-powered learning
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 max-w-4xl mx-auto">
          ...
          <Card className="p-6 sm:p-8 lg:p-10 bg-white/90 backdrop-blur border-2 border-green-300 shadow-xl hover:shadow-2xl transition-shadow duration-300">
            <div className="mb-4">
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 text-green-800">
                Free Trial
              </h3>
            ...
            <p className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-2 text-green-700">
              ₦0
            </p>
            ...
            <ul className="space-y-3 sm:space-y-4 mb-8 sm:mb-10 text-gray-700">
              <li className="flex items-start">
                <CheckCircle
                  className="mr-2 sm:mr-3 mt-0.5 text-green-600 shrink-0"
                  size={20}
                />{" "}
                <span className="text-sm sm:text-base">
                  Few questions from start
                </span>
              </li>
              <li className="flex items-start">
                <CheckCircle
          ...
          <Card className="p-6 sm:p-8 lg:p-10 bg-linear-to-br from-green-600 to-green-700 text-white transform md:scale-105 border-4 border-yellow-400 relative shadow-2xl hover:shadow-3xl transition-all duration-300">
            ...
            <ul className="space-y-3 sm:space-y-4 mb-8 sm:mb-10">
              ...
              <li className="flex items-start">
                <CheckCircle
                  ...
                  size={20}
                />{" "}
                <span className="text-sm sm:text-base">Leaderboard access</span>
              </li>
            </ul>
            <Link href="/subscribe">
        ...
        <div className="mt-12 sm:mt-16 text-center">
          ...
          <p className="text-sm text-gray-500">
            All plans include AI-powered features to boost your JAMB success
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-24 bg-white/50 backdrop-blur">
        <h2 className="text-5xl font-bold text-center mb-4 text-green-900">
          Frequently Asked Questions
        </h2>
        <p className="text-center text-gray-600 mb-16 text-lg">
          Everything you need to know about AUWebX Exam
        </p>
 ...
 */}
              ...
              <div className="mt-8 pt-6 border-t border-white/20">
                ...
                <p className="font-medium text-sm opacity-75 mt-2">
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <p className="text-green-200 mb-4">
                Nigerian leading online examination platform for JAMB, WAEC, and
                NECO preparation.
              </p>
